# Tube datasheets and extracted design values

Scans vendored from Dieter's Nixie Tube Data Archive (tube-tester.com) and
GRA & AFCH. The Soviet originals are image scans (no embedded text).
...
| Ignition voltage | verify in scan; NOS tubes drift upward with age |
| Digit height | 18 mm |
...
**Three electrodes** (footprint/symbol updated 2026-07-19 to match):
...
up to ~200 V for aged/dark tubes). Design the HV supply with headroom:
adjustable 170–190 V, or verify strike on the actual NOS stock before
freezing the rail at 170 V. IN-6 strikes at ≤140 V — no concern.
